...
import { handleSubmit } from '../inserisci/[type]/page'
  ...
  return (
     <form className='' onSubmit={handleSubmit}>
        ...
        <input type="text" id="secondo_nome" name="info.secondo_nome" value={formData.info.secondo_nome} onChange={handleChange} />
                ...
                <input type="text" id="dob" name="info.dob" value={formData.info.dob} onChange={handleChange} />
      ...
      <label htmlFor="costo">Costo Totale:</label>
      <input type="number" id="costo" name="payments.costo" value={formData.payments.costo} onChange={handleChange} />

      <label htmlFor="profitto">Profitto:</label>
      <input type="number" id="profitto" name="payments.profitto" value={formData.payments.profitto} onChange={handleChange} />
      ...
      <label htmlFor="fronte_path">Path Fronte Documento:</label>
      <input type="text" id="fronte_path" name="docs.identita.paths.fronte" value={formData.docs.identita.paths.fronte} onChange={handleChange} />

      <label htmlFor="retro_path">Path Retro Documento:</label>
      <input type="text" id="retro_path" name="docs.identita.paths.retro" value={formData.docs.identita.paths.retro} onChange={handleChange} />

      <label htmlFor="altro_nome">Nome Altro Documento:</label>
      <input type="text" id="altro_nome" name="docs.altro.nome" value={formData.docs.altro.nome} onChange={handleChange} />

      <label htmlFor="altro_path">Path Altro Documento:</label>
      <input type="text" id="altro_path" name="docs.altro.path" value={formData.docs.altro.path} onChange={handleChange} />
