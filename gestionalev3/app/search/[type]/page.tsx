  ...
  useEffect(() => {
    const fetchUsersData = async () => {
      try {
        ...
        const response = await fetch(`https://51.210.108.56:2000/${type}`);
        ...
        if (type === "students") {
          const courses = await axios.get("https://51.210.108.56:2000/courses")
          const enti = await axios.get("https://51.210.108.56:2000/enti")
