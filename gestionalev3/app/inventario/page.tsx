  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedFormData = {
        ...formData,
        ente: selectedCourse ? selectedCourse.ente : '', // Imposta l'ente corrispondente al corso selezionato
      };
      console.log(updatedFormData);

      const response = await axios.post('http://127.0.0.1:2000/stock/', updatedFormData);
