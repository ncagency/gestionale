...
const Ente = () => {
  ...
  return (
      <div  style={{ cursor: 'pointer' }} className='bg-warning p-5 fs-1 d-flex flex-column h-100 justify-content-center align-items-center rounded-4'> {/* INSERISCI UNA FUNZIONE CHE AL CLICK REINDIRIZZI NELLA PAGINA DI ADD*/}
